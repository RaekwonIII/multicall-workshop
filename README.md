# [Exiled Racers](https://www.exiledracers.com/) Indexer - A squid example for Moonbeam network

<p align="center">
	<img src="assets/exr_banner.png">
</p>
...
This project is a squid that indexes blockchain information generated by the [Exiled Racers Racecraft](https://moonscan.io/token/0x104b904e19fbda76bb864731a2c9e01e6b41f855) smart contract.
...
Similarly, the token metadata, is obtained through the `tokenURI` function of the smart contract, but the indexer connects to a [Multicall contract](https://moonscan.io/address/0x83e3b61886770de2f64aacad2724ed4f08f7f36b#code), the kind developed by [MakerDAO](https://github.com/makerdao/multicall).
...
```bash
sqd typegen assets/ERC721.json#erc721
```
